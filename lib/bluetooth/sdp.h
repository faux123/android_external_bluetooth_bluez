...
#define OBEX_MAS_SVCLASS_ID		0x1132
#define OBEX_MNS_SVCLASS_ID		0x1133
#define OBEX_MAP_SVCLASS_ID		0x1134
...
#define OBEX_MAP_PROFILE_ID		OBEX_MAP_SVCLASS_ID
#define OBEX_MAS_PROFILE_ID		OBEX_MAS_SVCLASS_ID
